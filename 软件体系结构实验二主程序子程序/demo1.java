package 软件体系结构实验二.软件体系结构实验二主程序子程序;
...
public class demo1 {
    ...
    public static void main(String[] args) {
        ...
        kwic.input("D:\\Java\\代码\\privatetest\\src\\软件体系结构实验二\\软件体系结构实验二输入输出文档\\input.txt");
        kwic.shift();
        kwic.alphabetizer();
        kwic.output("D:\\Java\\代码\\privatetest\\src\\软件体系结构实验二\\软件体系结构实验二输入输出文档\\output1.txt");
    }
